 ...
 */
public class SpUtil {
    public static final String FILE_NAME = "rnbridge";
     ...
     * @param bundleVersion
     */
    public static void setBundleVersion(Context context,Integer bundleId, String bundleVersion) {
        put(context, String.valueOf(bundleId), bundleVersion);
    }
